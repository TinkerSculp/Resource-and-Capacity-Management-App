        ...
        <div className="absolute top-full left-0 right-0 bg-white dark:bg-[#1f1f1f] border border-black dark:border-slate-600 rounded mt-1 z-50 max-h-64 overflow-y-auto shadow-lg dark:shadow-[0_10px_30px_rgba(0,0,0,0.45)]">
          ...
          {filtered.map((item) => (
            <div
              ...
              className={`p-2 cursor-pointer text-black dark:text-slate-100 hover:bg-[#017ACB]/20 dark:hover:bg-[#017ACB]/30 transition text-sm ${value === item.emp_name ? 'font-bold bg-[#CDE6F7] dark:bg-[#0A5F8A]/40' : ''}`}
              style={styles.outfitFont}
            >
              {item.emp_name}
            </div>
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[9999] px-4">
      <div className="bg-white dark:bg-[#212121] rounded-lg shadow-xl dark:shadow-[0_12px_40px_rgba(0,0,0,0.55)] border border-transparent dark:border-slate-700 w-full max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          <h2 className="text-2xl font-bold mb-6 text-black dark:text-white" style={styles.outfitFont}>
            Edit Resource
          </h2>
          ...
          <form onSubmit={handleEdit} noValidate>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  readOnly
                  className="bg-gray-100 text-gray-500 border border-black p-2 rounded cursor-not-allowed w-full dark:bg-slate-800 dark:text-slate-400 dark:border-slate-600"
                  style={styles.outfitFont}
                />
            ...
            <div className="mt-4">
              <label className="text-xs text-black dark:text-slate-100 font-semibold block mb-2" style={styles.outfitFont}>
                Status
              </label>
