...
export default function AddInitiativeModal() {
  ...
  /* ---------------------------------------------------------------------------
     HANDLER: fetchDept
     Fetches the department for a given VP name from the backend.
     Backend is the authoritative source — prevents user tampering.
  --------------------------------------------------------------------------- */
  ...
  /* ---------------------------------------------------------------------------
     ...
     Auto-fills VP and Department when a Requestor is selected.
  --------------------------------------------------------------------------- */
  ...
  /* ---------------------------------------------------------------------------
     ...
     Validates, builds payload, POSTs to API.
     On success: shows "Initiative added" banner for 1.5s then navigates back.
  --------------------------------------------------------------------------- */
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} noValidate>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              {/* PROJECT NAME — letters, numbers, spaces, commas, periods */}
              ...
              {/* TARGET PERIOD — letters, numbers, spaces, commas, periods */}
              <div className="flex flex-col">
                <label className="text-xs text-black mb-1 font-semibold" style={styles.outfitFont}>
                  Target Period *
                </label>
            ...
            {/* DESCRIPTION — letters, numbers, spaces, commas, periods */}
            ...
            {/* RESOURCE CONSIDERATION — letters, numbers, spaces, commas, periods */}
            <div className="flex flex-col mt-4">
              <label className="text-xs text-black mb-1 font-semibold" style={styles.outfitFont}>
