              ...
              {filteredInitiatives.map(item => {
                ...
                return (
                  ...
                  >
                    {/* EDIT — sticky left */}
                    <td
                      className={`sticky left-0 z-30 px-4 py-2 border-r border-black dark:border-slate-700 whitespace-nowrap ${isHighlighted ? 'bg-[#CDE6F7] dark:bg-[#0A5F8A]/30' : 'bg-white dark:bg-slate-900'}`}
