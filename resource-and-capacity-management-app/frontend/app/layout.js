    ...
    <html lang="en">
      ...
      >
        ...
        {/* -----------------------------------------------------
           ...
           • Ensures content is centered and readable on all screens
           • Acts as the primary container for all page-level content
           • Suspense boundary covers all children — required because
             multiple pages use useSearchParams() which cannot be
             statically prerendered without a Suspense wrapper
        ----------------------------------------------------- */}
        <main className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-6">
