...
export default function LoginPage() {
  ...
  return (
    <>
      {/* BACKDROP */}
      <div
        className="fixed inset-0 bg-white/30 dark:bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 px-4"
        onClick={() => router.push('/login')}
      >
        <div className="flex flex-col lg:flex-row items-center justify-center gap-4 w-full max-w-4xl" onClick={(e) => e.stopPropagation()}>

        {/* CARD */}
        <div
          className="bg-white dark:bg-slate-900 rounded-xl shadow-xl dark:shadow-[0_8px_40px_rgba(0,0,0,0.6)] p-6 sm:p-8 w-full max-w-lg border border-gray-200 dark:border-slate-700 flex-shrink-0"
          onClick={(e) => e.stopPropagation()}
        >
      ...
      {/* END CARD */}
        ...
        <div
          className="bg-white dark:bg-slate-900 rounded-xl shadow-xl dark:shadow-[0_8px_40px_rgba(0,0,0,0.6)] p-6 w-full max-w-xs border border-gray-200 dark:border-slate-700 flex-shrink-0 self-stretch flex flex-col justify-center"
          onClick={(e) => e.stopPropagation()}
        >
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={role} className="border border-gray-200 dark:border-slate-700 rounded-lg p-3">
                <p className="text-xs font-bold text-gray-500 dark:text-slate-400 uppercase tracking-wide mb-1.5" style={{ fontFamily: 'Outfit, sans-serif' }}>
                  {role}
                </p>
                <div className="space-y-1">
                  <div className="flex justify-between items-center">
                    ...
                    <button
                      ...
                      className="text-xs font-mono text-[#017ACB] dark:text-[#4DAEFF] hover:underline"
                      title="Click to copy"
                    >
                      {u}
                    </button>
            ...
            <div className="border border-gray-200 dark:border-slate-700 rounded-lg p-3 opacity-50">
              ...
              <p className="text-xs text-gray-400 dark:text-slate-500 italic" style={{ fontFamily: 'Outfit, sans-serif' }}>
        ...
        </div>{/* END DEMO CREDENTIALS PANEL */}
