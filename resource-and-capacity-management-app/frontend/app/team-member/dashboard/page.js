...
/* =============================================================================
   ...
   DEPENDENCIES:
     ...
     • DashboardTileIcon — Handles light/dark icon switching automatically
   ============================================================================= */
...
export default function TeamMemberDashboardPage() {
  ...
  --------------------------------------------------------------------------- */
  const tiles = [
    { label: 'Capacity Summary', icon: <DashboardTileIcon defaultSrc="/capacitysummary.svg" darkSrc="/WhiteCapacitySummary.svg" alt="Capacity summary icon" />, href: '/capacity-summary' },
