...
// //       <h2 className="text-[clamp(1.4rem,1.8vw,2.2rem)] text-gray-900 dark:text-slate-100 mb-[clamp(0.15rem,0.3vw,0.45rem)]" style={styles.outfitFont}>
...
// //           }
// //         ].map((item, i) => (
// //           <div key={i} className="bg-gray-200 rounded-lg shadow-sm dark:shadow-black/30 border border-gray-300 dark:bg-slate-900 dark:border-slate-700 p-[clamp(1rem,1.5vw,2rem)] transition">
// //             <p className="text-gray-600 dark:text-slate-300 text-[clamp(0.9rem,1.0vw,1.2rem)] text-center" style={styles.outfitFont}>{item.label}</p>
// //             <h3 className="flex items-center justify-center gap-2 text-[clamp(1.3rem,1.5vw,1.9rem)] font-semibold text-gray-900 dark:text-slate-100 mb-2" style={styles.outfitFont}>
...
//      • Inactive filter → Grey (gray-200) background, gray text
