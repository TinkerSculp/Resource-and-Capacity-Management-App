      ...
      <main className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-4 relative">
        ...
        <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
          <div className="flex items-center gap-4">
            <h2 className="text-2xl sm:text-3xl font-bold text-black" style={styles.outfitFont}>
              Calendar View
            </h2>
          ...
          <div className="flex justify-center w-full relative">
            ...
            <div
              ...
              className={`
                ...
                border border-black rounded-lg bg-white shadow overflow-hidden
              `}
            >
                      ...
                      {month.activities.length === 0 ? (
                        ...
                        <div className="space-y-6">
                          {['Baseline', 'Strategic', 'Discretionary', 'Vacation'].map(cat => {
                            ...
                            return (
                              <div key={cat}>
                                <h4 className="font-bold text-base sm:text-lg text-black mb-2" style={styles.outfitFont}>
                                  {cat}
                                </h4>
              ...
              >
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold mb-2 text-black" style={styles.outfitFont}>Months</h4>
                        ...
                        return (
                          ...
                          >
                            ...
                            ">
                              ...
                              {isSelected && (
                                <>
                                  <span className="absolute inset-0 bg-[#003A5C]" />
                  ...
                  <div className="w-36 flex flex-col justify-between">
                    <div>
                      <h4 className="font-semibold mb-2 text-black" style={styles.outfitFont}>View</h4>
