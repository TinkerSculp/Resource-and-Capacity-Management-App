...
//      • Passwords are hashed with bcrypt (cost 10) before storage — never plaintext.
...
//     // Hash password before storing — never write plaintext to the DB
...
//     // Only hash and update password if admin actually entered one
...
//    -----------------------------------------------------------------------------
//    One-time migration endpoint. Finds all accounts with plaintext passwords
//    (not starting with "$2b$") and hashes them with bcrypt.
//    Call this once after deploying, then it becomes a no-op.
//    ============================================================================= */
