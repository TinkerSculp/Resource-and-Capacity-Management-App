...
const API_BASE_URL =
  process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3001/api/Resource-Manager';
...
const ENDPOINTS = {
  ...
  AVAILABILITY_BY_EMPLOYEE: (employeeID) =>
    `${API_BASE_URL}/availability/${employeeID}`, // Get availability for one employee
